...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "d-smith-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/xtrac-arch"
  #   chef.validation_client_name = "xtrac-arch-validator"
  #   chef.validation_key_path = ".chef/xtrac-arch-validator.pem"
  # end
end
